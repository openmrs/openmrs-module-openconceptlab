 ...
 */
// generated on 2016-10-27 using generator-openmrs-owa 0.3.1
'use strict';
...
const THIS_APP_ID = 'openconceptlab';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/openconceptlab.js`,
	  css: `${__dirname}/app/css/openconceptlab.css`,
	  vendor : [
